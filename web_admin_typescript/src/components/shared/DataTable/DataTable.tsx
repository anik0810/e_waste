            ...
            <Card className="h-full w-full">
                <CardHeader floated={false} shadow={false} className="rounded-none">
                    <div className="mb-8 flex items-center justify-between gap-8">
                        ...
                        <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                            <Button variant="outlined" className="border-blue-500 text-indigo-500 inline-flex items-center" size="sm" onClick={handleRefresh}>
                                {/* <ArrowPathIcon /> */}
                                Refresh
                            </Button>
                        </div>
                ...
                <CardBody className="overflow-scroll px-0">
                    <table className="mt-4 w-full min-w-max table-auto text-left">
                        <thead>
                            <tr>
                                {TABLE_HEAD.map((head, index) => (
                                    <th
                                        key={head}
                                        className="cursor-pointer border-y border-blue-gray-100 bg-green-50 p-4 transition-colors hover:bg-white "
                                    >
                                        <Typography
                                            variant="small"
                                            color="black"
                        ...
                        <tbody>
                            {deviceList.map(
                                ({ device_id, device_location, e_waste }, index) => {
                                        ...
                                        <tr key={device_id}>
                                            ...
                                            <td className={classes}>
                                                <Typography
                                                    ...
                                                    className="font-normal"
                                                >
                                                    <EditCell device_id={device_id} data={e_waste} handleRefresh={handleRefresh} />
                                                </Typography>
                                            </td>
                                            <td className={classes}>
                                                <Typography
